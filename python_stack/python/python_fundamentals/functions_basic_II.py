...
def first_plus_length(list):
    ...
    sum += list[0] + len(list)
    return sum
test = first_plus_length([2,4,6,8,10])
print(test)
...
# that are greater than its 2nd value. Print how many values this is and then return the new list. If the list has less than 2 elements, have 
# the function return False. Example: values_greater_than_second([5,2,3,2,1,4]) should print 3 and return [5,3,4]
...
def values_greater_than_second(list):
    if len(list) < 2:
        ...
        print(len(new_list))
        return new_list
test = values_greater_than_second([3,5,1,2,3,7,9,4])
print(test)
...
def length_and_value(x,y):
    ...
    for x in range(0, x, 1):
        new_list.append(y)
    return new_list
test1 = length_and_value(5,1)
test2 = length_and_value(2,5)
print(test1)
print(test2)